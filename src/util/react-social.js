;(function (root, factory) {
	if (typeof module !== "undefined" && module.exports) {
	  ...
	  root.ReactSocial = factory(root.React, root.createClass, root.React.PropTypes);
	}
	...
	exports.WeiboButton = createClass({
		displayName: "WeiboButton"
		...
		, constructUrl: function () {
			return "http://v.t.sina.com.cn/share/share.php?title="
				+ encodeURIComponent(this.props.message)
				+ "&url=" + encodeURIComponent(this.props.url)
				+ "&source=bookmark&appkey=963619642&pic=" + encodeURIComponent(this.props.media)
				+ "&relateUid=";
		}
	});

	exports.DoubanButton = createClass({
		displayName: "DoubanButton"
		...
		, constructUrl: function () {
			return "http://shuo.douban.com/!service/share?image="
				+ encodeURIComponent(this.props.media)
				+ "&href=" + encodeURIComponent(this.props.url)
				+ "&name=" + encodeURIComponent(this.props.message)
		}
	});


	exports.QzoneButton = createClass({
		displayName: "QzoneButton"
		...
		, constructUrl: function () {
			return "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="
				...
				+ "&pics=" + encodeURIComponent(this.props.media)
				+ "&summary=";
		}
	});

	exports.WechatButton = createClass({
		displayName: "WechatButton"
		...
		, constructUrl: function () {
			return "http://www.qr-code-generator.com/phpqrcode/getCode.php?cht=qr&chl="
				+ encodeURIComponent(this.props.url)
